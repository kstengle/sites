...
/// <summary>
/// Base Page for Admin section of LACES project to include common functions
/// </summary>
    ...
    protected override void OnLoad(EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                PlaceHolder oHtmlTableCell = (PlaceHolder)Master.FindControl("uiPhMenu");
                oHtmlTableCell.Controls.Add(LoadControl("~/usercontrols/AdminMenu.ascx"));

                try
                {
                    //change the login status
            //        ((HtmlTableCell)Master.FindControl("loginTd")).Attributes["class"] = "loggedIn adminloginStatus";
                }
                catch (Exception ex) { }
                ...
                {
                    //change the login status
              //      ((HtmlImage)Master.FindControl("headImage")).Attributes["class"] = "leftmargin";
                }
                catch (Exception ex) { }
