 ...
 * Component Name: AttendeesSearchResult.aspx.cs
...
/// </summary>
public partial class Admin_AttendeesSearchResult : AdminBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       // Debugger.Break();
        ...
        {
            Response.Redirect("FindAttendees.aspx");
        }
    ...
    {
        Response.Redirect("FindAttendees.aspx?SearchAgain=true");
    }
