<%@ Page Language="C#" MasterPageFile="~/SingleColumnMaster.master" AutoEventWireup="true"
    CodeFile="ProviderDetails.aspx.cs" Inherits="Admin_ProviderDetails" Title="Admin: Contact Information | LA CES™" %>
    ...
    <table class="LeftAlignTable">
        ...
        <tr>
            <td class="frmElement2">
                Status</td>
            <td class="moreLineHeight">
                <asp:RadioButtonList ID="radStatus" runat="Server" RepeatDirection="Horizontal" CssClass="statusRadioButton"
                    BorderWidth="0px">
        ...
        <tr>
            ...
            <td class="moreLineHeight">
                <br />
                <asp:Button ID="Button1" runat="server" Text="SAVE DETAILS" CssClass="commonButton btn133"
