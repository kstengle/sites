...
/// </summary>
public partial class Visitor_CourseResult : VisitorBasePage
{
    ...
    private SearchCourse buildSearchCriteria()
    {
        ...
        if (searchQuery == "")
            searchQuery = "[tblCourseDetails].[Status] = 'OP' AND [EndDate] >= '" + DateTime.Today + "' AND [tblApprovedProvider].[Status] = 'Active'";
        else
            searchQuery += " AND ([tblCourseDetails].[Status] = 'OP' AND [EndDate] >= '" + DateTime.Today + "' AND [tblApprovedProvider].[Status] = 'Active')";
