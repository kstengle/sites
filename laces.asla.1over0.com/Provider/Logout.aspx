<%@ Page Language="C#" MasterPageFile="~/Provider/ProviderMaster.master" AutoEventWireup="true" CodeFile="Logout.aspx.cs" Inherits="Provider_Logout" Title="Logout | LA CES™" %>
