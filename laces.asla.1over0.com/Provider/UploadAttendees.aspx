<%@ Page Language="C#" MasterPageFile="~/SingleColumnMaster.master" AutoEventWireup="true"
    CodeFile="UploadAttendees.aspx.cs" Inherits="Provider_UploadAttendees" Title="Upload Attendees in Excel| LA CES™" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderLeftPane" runat="Server">
    ...
    <div class="title" id="dvHeader" runat="server">
    ...
    <div>
       ...
       <%-- Upload MS Excel File<br />--%>
        ...
        <div id="lb_error_message" style="padding-top: 10px;" runat="server">
        </div>
        <br />
